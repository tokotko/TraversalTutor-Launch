...
Floyd.SMALL_COST_TABLE_START_Y = 120; // 70

Floyd.SMALL_PATH_TABLE_WIDTH = 30;
Floyd.SMALL_PATH_TABLE_HEIGHT = 30;
Floyd.SMALL_PATH_TABLE_START_X = 330;
Floyd.SMALL_PATH_TABLE_START_Y = 120; // 70


Floyd.SMALL_NODE_1_X_POS = 50;
Floyd.SMALL_NODE_1_Y_POS = 450; // 400
Floyd.SMALL_NODE_2_X_POS = 150;
Floyd.SMALL_NODE_2_Y_POS = 400; // 350
Floyd.SMALL_NODE_3_X_POS = 250;
Floyd.SMALL_NODE_3_Y_POS = 450; // 400

Floyd.SMALL_MESSAGE_X = 400;
Floyd.SMALL_MESSAGE_Y = 400; // 350

Floyd.LARGE_COST_TABLE_WIDTH = 25; // 20
Floyd.LARGE_COST_TABLE_HEIGHT = 25; // 20
Floyd.LARGE_COST_TABLE_START_X = 40; // 40
Floyd.LARGE_COST_TABLE_START_Y = 60; // 50

Floyd.LARGE_PATH_TABLE_WIDTH = 25; // 20
Floyd.LARGE_PATH_TABLE_HEIGHT = 25; // 20
Floyd.LARGE_PATH_TABLE_START_X = 525; // 500
Floyd.LARGE_PATH_TABLE_START_Y = 60; // 50

Floyd.LARGE_NODE_1_X_POS = 350; // 50
Floyd.LARGE_NODE_1_Y_POS = 600; // 500
Floyd.LARGE_NODE_2_X_POS = 450; // 150
Floyd.LARGE_NODE_2_Y_POS = 550; // 450
Floyd.LARGE_NODE_3_X_POS = 550; // 250
Floyd.LARGE_NODE_3_Y_POS = 600; // 500

Floyd.LARGE_MESSAGE_X = 600; // 300
Floyd.LARGE_MESSAGE_Y = 550; // 450
