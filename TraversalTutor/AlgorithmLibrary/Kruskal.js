...
Kruskal.HIGHLIGHT_CIRCLE_COLOR = "#000000";
 ...
 Kruskal.SET_ARRAY_ELEM_WIDTH = 34; // 25
 Kruskal.SET_ARRAY_ELEM_HEIGHT = 34; // 25
 Kruskal.SET_ARRAY_START_X = 55; // 50
 Kruskal.SET_ARRAY_START_Y = 70; // 130
 ...
 Kruskal.FIND_LABEL_1_X = 120; // 30
 Kruskal.FIND_LABEL_2_X = 235; // 100
 Kruskal.FIND_LABEL_1_Y = 30;
 Kruskal.FIND_LABEL_2_Y = Kruskal.FIND_LABEL_1_Y;

 Kruskal.MESSAGE_LABEL_X = 120; // 30
