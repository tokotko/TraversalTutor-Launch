...
TopoSortIndegree.INDEGREE_ARRAY_ELEM_WIDTH = 30; // 25
TopoSortIndegree.INDEGREE_ARRAY_ELEM_HEIGHT = 30; // 25
TopoSortIndegree.INDEGREE_ARRAY_START_X = 75; // 50
TopoSortIndegree.INDEGREE_ARRAY_START_Y = 100; // 60
...
TopoSortIndegree.MESSAGE_LABEL_1_Y = 5; //10

TopoSortIndegree.MESSAGE_LABEL_2_X = 100; // 70
TopoSortIndegree.MESSAGE_LABEL_2_Y = 40;


TopoSortIndegree.HIGHLIGHT_CIRCLE_COLOR = "#000000";
TopoSortIndegree.MESSAGE_COLOR = "#FFFFFF";
...
TopoSortIndegree.prototype.doTopoSort = function(ignored)
{
	...
	this.cmd("SetText", this.message1ID, "Calculate indegree of all verticies by going through every edge of the graph");
	...
	this.cmd("SetText", this.message1ID, "Collect all vertices with 0 indegree onto a stack");
	...
	while (stackTop >  0)
	{
		...
		this.cmd("SetText", this.message1ID, "Pop off top vertex with indegree 0, add to topological sort");
		...
		this.cmd("Step");
		this.cmd("SetText", this.message1ID, "Find all neigbors of vertex " + String(nextElem) + ", decrease their indegree.  If indegree becomes 0, add to stack");
